...
| R11: deterministic coverage | Proven by 108 tests plus the 17-step semantic browser journey under both development and production CSP, and the external 11-step smoke layer |
