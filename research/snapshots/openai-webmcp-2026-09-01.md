...
OverviewFeaturesConfigurationDevelopersSecurityAdministrationUse CasesResourcesDocsDevelopers

- [Overview](https://learn.chatgpt.com/docs/developers)
...
- [Modes](https://learn.chatgpt.com/docs/environments/modes)
...
- [MCP Server](https://learn.chatgpt.com/docs/mcp-server)
- [GitHub Action](https://learn.chatgpt.com/docs/github-action)
- [Non-interactive mode](https://learn.chatgpt.com/docs/non-interactive-mode)

### Third-party integrations

- [GitHub](https://learn.chatgpt.com/docs/third-party/github)
- [GitLab (Beta)](https://learn.chatgpt.com/docs/third-party/gitlab)
- [Slack](https://learn.chatgpt.com/docs/third-party/slack)
- [Linear](https://learn.chatgpt.com/docs/third-party/linear)
...
![](https://learn.chatgpt.com/images/codex/webmcp/margin-logo.webp)Margin — Local-first writing with comments

margin-local-docs.openai.chatgpt.site

![](https://learn.chatgpt.com/images/codex/icons/chat-reply-plus.svg)
...
Margin is a quiet place for notes, drafts, and decisions.

Site tools

Site tools help ChatGPT use this website to complete tasks more accurately and with fewer steps. [Learn more](https://webmachinelearning.github.io/webmcp/)

Available site tools (10)3 read, 7 write tools
...
[next section](https://learn.chatgpt.com/docs/webmcp#add-webmcp-to-your-website). ChatGPT Work and Codex may still
